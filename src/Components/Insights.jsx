        ...
        <div className="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-3 mb-4">
          <div>
            ...
            <p className="authority-subtext mb-0">
              Expert analysis, market updates, and educational content on
              Shariah-compliant finance &amp; investments.
            </p>
          </div>
          <a href="#blog" className="insights-view-all fw-semibold text-decoration-none">
            View all articles →
          </a>
        </div>
        ...
        <div className="row g-4">
          {ARTICLES.map((article) => (
            <div className="col-lg-4 col-md-6 col-12" key={article.tag}>
              <a href={article.href} className="insights-card text-decoration-none h-100 d-block">
                <div className="insights-card-body p-4 rounded-4 h-100">
                  ...
                  <h3 className="insights-title fw-bold mb-2">{article.title}</h3>
