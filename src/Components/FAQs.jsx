...
const FAQ_ITEMS = [
  {
    q: "What is Sharia compliance?",
    a: "Sharia compliance refers to the adherence to Islamic law or Sharia principles, particularly in finance and investment. It ensures investments align with Islamic ethical standards, excluding businesses involved in forbidden (Haram) activities like alcohol, gambling, or conventional financial services, and not excessively burdened with debt.",
  },
  {
    q: "Is the Stock Market Halal in Islam?",
    a: "Yes, investing in the stock market can be Halal—provided you follow Islamic investment principles related to trading and Sharia screening criteria developed by a competent Sharia Board. At Zamzam Capital, we offer our followers a thoroughly vetted Halal Stock List to help you invest with confidence.",
  },
  {
    q: "What are the Halal stocks available for Trading or Investment in India?",
    a: "Our list of Halal stocks in India is updated semi-annually by Zamzam Capital based on financial performance and compliance with Sharia screening criteria. We conduct a 3-level screening process and in the third level check for various qualitative criteria that is not picked up by financial screening.",
  },
  {
  ...
  {
    q: "How do I invest in Sharia-compliant stocks in India?",
    a: "To invest in Sharia-compliant stocks in India, start by referring to a verified Halal stocks list, such as the one curated by Zamzam Capital. Open a demat account with a reliable broker and choose stocks by referring to our Halal stocks list after conducting your own research.",
  },
  {
    q: "Where can I find a list of Halal mutual funds available for the Indian share market?",
    a: "As a SEBI Registered Research Analyst, our focus is on offering you Sharia compliant direct stock picks and model portfolios. We recommend you analyze any mutual fund that calls itself Sharia compliant very strictly and review their component stock list against our Halal stock list.",
  },
  {
    q: "What makes a stock Sharia-compliant?",
    a: "A Sharia-compliant stock must be from a business with a Halal primary activity, maintain acceptable levels of debt, impure income, non-compliant investments, illiquid assets, and liquidity, and avoid promoting non-Sharia compliant activities. Our screening criteria follows the methodology of Mufti Taqi Usmani (DB).",
  },
  {
    q: "Is intraday trading Halal or Haram?",
    a: "Intraday trading is not Halal, as it typically involves buying and selling shares without taking constructive possession, which is against Sharia principles. Halal trading requires ownership transfer and cannot be speculative or based on leverage.",
  },
  {
      ...
      <div className="container max-w-800 mx-auto">
        ...
        <div className="faq-accordion d-flex flex-column gap-2">
          {FAQ_ITEMS.map((item, idx) => {
            ...
            return (
              <div
                className={`faq-item rounded-3 ${isOpen ? "faq-item-open" : ""}`}
                key={idx}
              >
                <button
