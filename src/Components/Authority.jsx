        ...
        <div className="row g-4">
          ...
          <div className="col-xl-3 col-md-6 col-12">
            <div className="authority-strict-card p-4 rounded-4 h-100 d-flex flex-column align-items-start text-start">
              ...
              <h3 className="strict-card-title fw-bold mb-3">Sharia Compliance</h3>
              <p className="strict-card-desc mb-0">
                Rigorous 3-stage screening process overseen by certified Sharia
          ...
          <div className="col-xl-3 col-md-6 col-12">
            <div className="authority-strict-card p-4 rounded-4 h-100 d-flex flex-column align-items-start text-start">
              ...
              <h3 className="strict-card-title fw-bold mb-3">Model Portfolios</h3>
              <p className="strict-card-desc mb-0">
                Curated baskets for conservative, balanced, and growth investors.
              </p>
            </div>
          </div>
        </div>
